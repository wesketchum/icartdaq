#ifndef artdaq_demo_Generators_NormalSimulator_hh
#define artdaq_demo_Generators_NormalSimulator_hh

// NormalSimulator is a simple type of fragment generator intended to be
...
// NormalSimulator is designed to simulate values coming in from one of
...
namespace demo {    
  ...
  class NormalSimulator : public artdaq::CommandableFragmentGenerator {
  public:
    explicit NormalSimulator(fhicl::ParameterSet const & ps);
...
#endif /* artdaq_demo_Generators_NormalSimulator_hh */
