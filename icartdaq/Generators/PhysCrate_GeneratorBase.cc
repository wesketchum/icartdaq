...
bool icarus::PhysCrate_GeneratorBase::getNext_(artdaq::FragmentPtrs & frags) {
  ...
  metricMan_->sendMetric(".GetData.Size",last_read_data_size_,"bytes",5,true,true);
  metricMan_->sendMetric(".GetData.Size.last",last_read_data_size_,"bytes",5,true,false);
  metricMan_->sendMetric(".GetData.Size.min",last_read_data_size_,"bytes",5,true,false);
  metricMan_->sendMetric(".GetData.Size.max",last_read_data_size_,"bytes",5,true,false);
  ...
  metricMan_->sendMetric(".getNext.EventNumber.last",(int)ev_num,"events",5,true,false);
